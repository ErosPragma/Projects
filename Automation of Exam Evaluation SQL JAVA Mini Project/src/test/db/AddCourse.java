...
public class AddCourse extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        name[0] = jTextField2.getText();
        name[1] = jTextField14.getText();
        name[2] = jTextField15.getText();
        name[3] = jTextField17.getText();
        name[4] = jTextField18.getText();
        name[5] = jTextField16.getText();
        name[6] = jTextField19.getText();
        ...
        {
            dispose();
            new AddCourse("Invalid Entry").show();
        }
        else
        {    
            
            code[1] = Integer.parseInt(jTextField13.getText());
            code[2] = Integer.parseInt(jTextField3.getText());
            code[3] = Integer.parseInt(jTextField5.getText());
            code[4] = Integer.parseInt(jTextField8.getText());
            code[5] = Integer.parseInt(jTextField10.getText());
            code[6] = Integer.parseInt(jTextField12.getText());
            try{  
                ...
                for (int i=1;i<=6;i++)
                    stmt.executeUpdate("insert into course values ("+code[i]+",\'"+name[i]+"\',\'"+name[0]+"\');");
                dispose();
                new AddCourse("Course Added Successfully").show();
                }
            }
            catch(Exception e)
            { 
                ...
                dispose();
                new AddCourse("Invalid/Duplicate Entry").show();
            }  
        }
