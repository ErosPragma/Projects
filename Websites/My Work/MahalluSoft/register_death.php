...
<body>
                ...
                <div class="row">
                  ...
                  <div class="col-md-5 col-xs-12 item ">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate">Death Reg. No</label>
                      <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate date-before">Date of Death</label>
                      <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate">Cause of Death</label>
                      <div class="col-md-8">
                      <select class="form-control round-form">
                            <option></option>
                        </select>
                  ...
                  <div class="col-md-5 col-xs-12 item ">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" id="inlineCheckbox1" value="option1"> If Qabar Booked
                        </label>
                    </div>
    ...
    <script>
          $('#nav-accordion .mt a').removeClass('active');          
            ...
            $('#nav-accordion .sub-menu .sub #death').addClass('active');
