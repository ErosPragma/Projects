...
<body>
        ...
        <div class="row mt">
          <div class="col-lg-12" id="main">
            ...
            <div class="border-head" id="home">
                <br>
                <h3><em>Staff Registration</em></h3>
              </div>
              ...
              <br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-5 col-xs-12 item ">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate">Staff ID</label>
                      <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate">Institution</label>
                      <div class="col-md-8">
                        <select class="form-control round-form">
                            <option></option>
                        </select>
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate phone">Contact No. 1</label>
                      <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label phone">Contact No. 2</label>
                      <div class="col-md-8">
                        <input type="number" class="form-control round-form">
                      </div>
                    </div>
                  ...
                  <div class="col-md-5 col-xs-12 item ">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label  validate">Qualification</label>
                      <div class="col-md-8">
                        <input type="text" class="form-control round-form">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate date-before">Date of Joining</label>
                      <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate">Designation</label>
                      <div class="col-md-8">
                        <input type="text" class="form-control round-form">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label validate">Salary</label>
                      <div class="col-md-8">
                        <input type="number" class="form-control round-form">
                      </div>
                    </div>
    ...
    <script>
          $('#nav-accordion .mt a').removeClass('active');          
            ...
            $('#nav-accordion .sub-menu .sub #staff').addClass('active');
